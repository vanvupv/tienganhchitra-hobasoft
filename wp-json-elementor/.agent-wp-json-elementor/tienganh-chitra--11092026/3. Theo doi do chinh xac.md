...
| **Section 2** | **Đội Ngũ Giảng Viên** (`giang_vien`) | `posts` | **95%** | ✅ Hoàn toàn Native | Query động đúng CPT `giang_vien`, 4 cột Desktop, màu viền `#28A745`. *Có thể nâng cấp `loop-carousel` nếu cần trượt slider.* |
| **Section 3** | **Chương Trình Đào Tạo** (`khoa_hoc`) | `posts` | **98%** | ✅ Hoàn toàn Native | 3 cột Desktop chuẩn, viền `#007BFF`, nút CTA cam `#ED9717`, tự động lấy trích dẫn & chi tiết khóa học. |
...
| **Section 5** | **Bảng Vàng Học Viên** (`hoc_vien`) | `posts` | **95%** | ✅ Hoàn toàn Native | 4 cột Desktop, bo góc viền xanh lá `#28A745`, tự động liên kết thành tích của từng học viên xuất sắc. |
| **Section 6** | **Tin Tức & Blog Mới Nhất** (`post`) | `posts` | **96%** | ✅ Hoàn toàn Native | Lưới 3 cột Desktop, liên kết chuẩn Blog tin tức WordPress, tối ưu bố cục bài viết mới. |
| **TỔNG THỂ** | **TOÀN TRANG CHỦ (6 SECTIONS)** | **Elementor Pro 3.x** | **97.0%** | **✅ 100% GỐC (0% CSS RÁC)** | **Đạt chuẩn sạch, sẵn sàng bàn giao & vận hành thực tế.** |
...
| **2. Loại bỏ Shadow** | Không dùng `box-shadow`, chuyển sang Flat Clean UI | ✅ ĐẠT (100%) | Không còn thuộc tính shadow; sử dụng viền mảnh `1px - 1.5px` tinh tế. |
| **3. Màu Xanh Dương** | `#007BFF` (Màu nhận diện chính: Khóa học, Tiêu đề) | ✅ ĐẠT (100%) | Đúng mã Hex chuẩn, thể hiện tính chuyên nghiệp & giáo dục. |
| **4. Màu Xanh Lá** | `#28A745` (Màu sinh khí: Giảng viên, Học viên, Badge) | ✅ ĐẠT (100%) | Màu xanh lá thân thiện, tạo cảm giác tin cậy và phát triển. |
| **5. Màu Cam Điểm Nhấn** | `#ED9717` (Màu nút hành động CTA, Ngôi sao review) | ✅ ĐẠT (100%) | Nổi bật thu hút cú nhấp chuột đăng ký của phụ huynh/học viên. |
| **6. Màu Chữ & Độ Tương Phản** | `#000000` (Nền sáng), `#FFFFFF` (Nền màu) | ✅ ĐẠT (100%) | Đảm bảo độ tương phản cao, dễ đọc cho mọi lứa tuổi. |

---

## 📱 3. MA TRẬN PHẢN HỒI ĐA THIẾT BỊ (RESPONSIVE BEHAVIOR AUDIT)

| Section | Desktop ($\ge 1024\text{px}$) | Tablet ($768\text{px} - 1023\text{px}$) | Mobile ($< 768\text{px}$) | Trải Nghiệm & Đề Xuất Tối Ưu Mobile |
| :--- | :---: | :---: | :---: | :--- |
...
| **Section 2: Giảng viên** | 4 Cột ngang | 2 Cột $\times$ 2 Hàng | 1 Cột dọc (100% width) | Card rộng rãi, thấy rõ chân dung giảng viên. |
| **Section 3: Khóa học** | 3 Cột ngang | 2 Cột | 1 Cột dọc | Nút đăng ký tư vấn to rõ, bấm ngón tay dễ dàng. |
| **Section 4: Đánh giá** | 3 Slide xoay vòng | 2 Slide xoay vòng | 1 Slide đơn | Hỗ trợ vuốt ngón tay (Touch Swipe) mượt mà. |
| **Section 5: Bảng vàng** | 4 Cột ngang | 2 Cột $\times$ 2 Hàng | 1 Cột dọc | Tôn vinh hình ảnh và điểm số IELTS / Cambridge. |
| **Section 6: Tin tức** | 3 Cột ngang | 2 Cột | 1 Cột dọc (hoặc Vuốt ngang) | **Cân nhắc:** Nếu để 6 bài nên áp dụng *Vuốt ngang (Horizontal Swipe)* để tránh cuộn trang quá dài. |
